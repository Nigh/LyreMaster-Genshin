...
ui.ver.pos:={x:ui.size.w-ui.ver.size.w-ui_gap,y:1.8*ui_gap}
ui.title:={}
ui.title.size:={w:ui.size.w-2*ui_gap-ui.ver.size.w,h:48}
...
edit_y:=3.5*ui_gap
checkbox_height:=15
edit_height:=ui.size.h-edit_y-ui.button1.size.h-2*ui_gap-15
checkbox_y:=edit_y+edit_height+0
Gui, Add, Edit, x30 y%edit_y% w440 h%edit_height% vediter hwndhEdit1, % sample_sheet
Gui, add, Checkbox, x30 y%checkbox_y% h%checkbox_height% vhardcore, hardcore 硬核模式
...
if debug
{
	hBitmap.title:=hBitmapBy2ColorAndText(ui.title.size.w,ui.title.size.h,ui.fgcolor,"DEBUG","bold cFF7799CC S48 Left")
}
Else
{
	hBitmap.title:=hBitmapBy2ColorAndText(ui.title.size.w,ui.title.size.h,ui.fgcolor,"LyreMaster","bold cFF7799CC S48 Left")
}
...
hBitmap.hotkey:=hBitmapBy2ColorAndText(ui.button1.size.w,20,ui.fgcolor,"F8:Stop F9:Start","bold cFF7799CC S14 Left")

hBitmap.button1:=hBitmapByBorderHatchAndText(ui.button1.size.w,ui.button1.size.h, 0xFF7799CC,2,ui.fgcolor,ui.bgcolor,ui.hatch,"Play")
hBitmap.button1Hover:=hBitmapByBorderHatchAndText(ui.button1.size.w,ui.button1.size.h, 0xFF7799CC,8,0xFF7799CC,ui.bgcolor,38,"Play")
